        ...
        <div className="flex items-center gap-2">
          ...
          <div className="inline-flex rounded-md shadow-sm" role="group">
            <button
              ...
              className={`px-3 py-1.5 text-sm border ${globalPartyModel === 'Supplier' ? 'bg-primary-600 text-white border-primary-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'}`}
            >
              Supplier
            </button>
            <button
              ...
              className={`px-3 py-1.5 text-sm border -ml-px ${globalPartyModel === 'Customer' ? 'bg-primary-600 text-white border-primary-600' : 'bg-white text-gray-700 border-gray-300 hover:bg-gray-50'}`}
            >
              Customer
            </button>
          </div>
                ...
                <tr key={idx}>
                  <td className="px-3 py-2">
                    <input
                      ...
                      className="w-full border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                    />
                  </td>
                  <td className="px-3 py-2">
                    <div className="relative" ref={(el) => { partyRowRefs.current[idx] = el; }}>
                      <div className="flex items-center">
                        <input
                          ...
                          className={`flex-1 border rounded-l-md px-2 py-1 text-sm min-w-[7rem] focus:outline-none focus:ring-1 focus:ring-primary-500 ${row.partyId ? 'border-gray-300' : (row.partyName ? 'border-error-500' : 'border-gray-300')}`}
                        />
                        <button
                          type="button"
                          onClick={() => (row.partyDropdownOpen ? closeAllDropdowns() : openPartyDropdown(idx))}
                          className="px-2 py-1.5 border border-l-0 border-gray-300 rounded-r-md text-sm bg-white hover:bg-gray-50"
                        >
                  ...
                  <td className="px-3 py-2">
                    <input
                      ...
                      className="w-full min-w-[9rem] border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                    />
                  </td>
                  <td className="px-3 py-2">
                    <select
                      ...
                      className="w-full min-w-[7rem] border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                    >
                  ...
                  <td className="px-3 py-2">
                    <input
                      ...
                      className="w-32 border border-gray-300 rounded-md px-2 py-1 text-sm text-right focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                    />
                  </td>
                  <td className="px-3 py-2">
                    <select
                      ...
                      className="w-full max-w-[6rem] border border-gray-300 rounded-md px-2 py-1 text-sm focus:outline-none focus:ring-1 focus:ring-primary-500 focus:border-primary-500"
                    >
